...
// Front 1
   ...
   //// Front 1
   //vector3 set1 = vector3(0.0f, 0.0f, 0.0f);
   //vector3 set2 = vector3(0.0f, (Engine::ASPECT_RATIO * sideLength) / Engine::SCREEN_HEIGHT, 0.0f);
   //vector3 set3 = vector3(sideLength / Engine::SCREEN_WIDTH, (Engine::ASPECT_RATIO * sideLength) / Engine::SCREEN_HEIGHT, 0.0f);
   //AddTri(triple(set1, set2, set3, frontColor));
   ...
   //AddTri(triple(set1, set2, set3, topColor));
   //triple TOP = triple(set1, set2, set3);
   //vector3 normal = ComputeNormal(TOP);
   //cout << normal.y << endl;
